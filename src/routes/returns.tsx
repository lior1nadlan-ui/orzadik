  ...
  return (
    <article className="container mx-auto px-4 py-12 md:py-16 max-w-3xl">
      ...
      <PolicySection id="eich" title="איך מבטלים">
        ...
        <p>
          בהודעה יש לציין את שם הלקוח ואת מספר ההזמנה (ובמקרה הרלוונטי — מספר תעודת זהות). נמסור
          לכם אישור בכתב על קבלת הודעת הביטול.
        </p>
      </PolicySection>
      ...
      <PolicySection id="hechzer" title="החזר כספי">
        ...
        <p>
          <strong>בביטול עקב פגם או אי-התאמה</strong> — מוחזר מלוא הסכום ששולם, ללא דמי ביטול, ואינכם
          נושאים בעלות ההחזרה.
        </p>
        <p>
          ...
          {CONSUMER_POLICY.cancellationFeePct}% ממחיר המוצר או {CONSUMER_POLICY.cancellationFeeCapIls}{" "}
      ...
      <PolicySection id="harig" title="חריג — מוצרים בהתאמה אישית">
        <p>
          ...
          בהתאם, מוצרים הכוללים <strong>חריטת לייזר, רקמה, הקדשה אישית, שמות או הזמנה מיוחדת לפי
          מידות</strong> אינם ניתנים לביטול או להחזרה לאחר תחילת תהליך ההתאמה.
        </p>
        <p>
      ...
      <PolicyFootnote>
        עמוד זה מסכם את מדיניות הביטול לנוחותכם. הנוסח המחייב הוא סעיף 7 —
        "ביטול עסקה, החזרות והחזרים" — ב<Link to="/terms" hash="bitul">תקנון ותנאי השימוש</Link>.
