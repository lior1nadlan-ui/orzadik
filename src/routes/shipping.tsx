    ...
    <article className="container mx-auto px-4 py-12 md:py-16 max-w-3xl">
      ...
      <PolicySection id="zmanim" title="זמני אספקה">
        <p>
          ...
          ההזמנה. אישור ההזמנה הוא הרגע שבו התקבל אישור החיוב מחברת האשראי ואומתה זמינות המוצר במלאי
          — ולא רגע שליחת ההזמנה באתר.
        </p>
        <p>
      ...
      <PolicySection id="ikuvim" title="עיכובים וכתובת למשלוח">
        <p>
          באחריותכם למסור כתובת מדויקת ומלאה ולוודא זמינות לקבלת המשלוח. עיכוב או כשל באספקה שנובעים
          מכתובת שגויה או חסרה, או מאי-מענה לשליח, הם באחריות הלקוח ואינם מזכים בהחזר דמי משלוח.
        </p>
        <p>
      ...
      <PolicyFootnote>
        עמוד זה מסכם את מדיניות המשלוחים לנוחותכם. הנוסח המחייב הוא סעיף 6 — "אספקה ומשלוחים" — ב
        <Link to="/terms" hash="mishloch">
          תקנון ותנאי השימוש
        </Link>
        .
      </PolicyFootnote>
