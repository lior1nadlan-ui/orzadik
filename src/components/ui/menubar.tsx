...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-lg origin-(--radix-menubar-content-transform-origin) transition-[opacity,transform,scale,translate] duration-200 ease-out starting:opacity-0 starting:scale-95",
      className,
    )}
    {...props}
  />
...
>(({ className, align = "start", alignOffset = -4, sideOffset = 8, ...props }, ref) => (
  <MenubarPrimitive.Portal>
    <MenubarPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[12rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md origin-(--radix-menubar-content-transform-origin) transition-[opacity,transform,scale,translate] duration-200 ease-out starting:opacity-0 starting:scale-95",
        className,
      )}
      {...props}
    />
