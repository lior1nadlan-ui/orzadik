...
export const OCCASION_COLLECTIONS: OccasionCollection[] = [
  {
    ...
    metaTitle: "מתנות לבר מצווה — טלית, תפילין, סידור וכיסויים | אור זרוע לצדיק",
    metaDescription:
    ...
    faq: [
      {
        ...
        a: "המתנות הקלאסיות לבר מצווה הן טלית, תפילין וכיסוי או תיק לתפילין, לצד סידור ועטרה. בעמוד זה מרוכזים פריטים מכל הקטגוריות האלה מתוך הקטלוג של אור זרוע לצדיק.",
      },
      {
  ...
  },
  {
    ...
    categorySlugs: [
      ...
      "talit-tefillin-covers", // כיסויים לטלית (לטלית החתן)
      "talit-tefillin-sets", // סטים לטלית ותפילין
